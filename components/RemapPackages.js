...
export default class X012Login extends Component {
      ...
      packagesDetails: [
        {
          ...
          interior: {
            services: [
              'A Bespoke Custom Stage 1/2 Remap with Performance or EcoRemap created specifically for your vehicle within a safe limit.Gain at least a 20% BHP Increase and 30% Torque increase on	your vehicle.	'
            ],
            image: require('../assets/audi.png'),
          },

          addons: [
            { title: 'Full Coding Session', price: '40', selected: false },
            { title: 'Video in Motion', price: '40', selected: false },
            { title: 'Gearbox Tune (BMW)', price: '190', selected: false }
          ],
          years: [
  ...
  getPackagePricings = () => {
    ...
    fetch('https://lab.mediabloo.com/api/v1/remaps-packages', {
      method: 'GET',
      headers: {
    ...
    return (
      <SafeAreaView style={styles.mainContainer}>
        ...
        <View
          ...
          <Text style={styles.heading}>Remaps/ ECU / Gearbox Tuning</Text>
        ...
        <ScrollView style={styles.servicesScroller}>
          <Image style={styles.image} source={require('../assets/remap.png')} />
        ...
        <View style={styles.startView}>
          <View style={styles.packagesDetailModalView}>
            ...
            <Text style={styles.packageModalText}>
              {this.state.packagesInfo != null && this.state.packagesInfo[this.state.selectedPackage].package_name}
            </Text>
            <ScrollView style={{ width: '100%', marginTop: 20, paddingRight: 10 }}>
              <View
                ...
                <View style={{ padding: 10 }}>
                  ...
                  <HTML tagsStyles={{ p: { color: 'white', marginTop: 10 }, li: { color: 'white' }, ul: { marginLeft: -20, marginTop: 10 } }} contentWidth={100} source={{ html: this.state.packagesInfo != null && this.state.packagesInfo[this.state.selectedPackage].features }} />
                </View>
                  ...
                  return (
                    <View
                      ...
                      <View>
                        <TouchableOpacity
                          onPress={() => {
                            this.setState({ packageName: item.package_name })
