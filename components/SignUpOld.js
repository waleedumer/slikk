  ...
  render() {
    return (
      <SafeAreaView
        ...
        <View
          style={styles.x012Login_rectangle31}></View>
        <Svg
        ...
        <TouchableOpacity style={styles.x012Login_login09a3157b} onPress={this.loadLogin}>
        ...
        <View source={require('../assets/group8.png')} style={styles.x012Login_group8}>
          ...
          <View style={styles.x012Login_mainHeading}>
            <Text style={styles.x012Login_mainHeading_login7a308dfa}>Sign up</Text>
          </View>
          <View style={styles.fieldsWrapper}>
            ...
            <View style={styles.fieldWrapperHalf}>
              ...
              <View style={styles.halfFieldWrapper}>
                <View style={styles.labelWrapper}>
                  <Text onChangeText={(text) => this.setState({ address: text })} style={styles.label}>Address*</Text>
                </View>
                <SafeAreaView style={styles.x012Login_rectangle30}>
        ...
        <TouchableOpacity onPress={this.registerUser} style={styles.x012Login_rectangle23}>
          <View style={styles.x012Login_rectangle23}></View>
          <Text style={{ fontSize: 16 }}>{this.state.btnText}</Text>
        </TouchableOpacity>
      </SafeAreaView>
    );
  }
