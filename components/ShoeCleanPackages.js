...
export default class X012Login extends Component {
  constructor(props) {
    super(props);
    this.state = {
      selectDesign: 'Select Package',
      selectColour: 'Select Colour',
      selectType: 'Select Time',
      ...
      sizeValue: null,
      sizeItems: [
        { label: '3 - 5.5      £105', value: '3-5.5' },
        { label: '6 - 17       £135', value: '6-17' }
      ],
      ...
      packages: [
        {
          ...
          title: 'Standard',
          price: '£15',
          image: require('../assets/clean1.png'),
        },
        {
          id: 1,
          title: 'Premium',
          price: '£35',
          image: require('../assets/clean2.png'),
        },
        {
          id: 1,
          title: 'Restoration',
          price: '',
          image: require('../assets/clean3.png'),
        },
  ...
  getPrices(token) {
    fetch('https://lab.mediabloo.com/api/v1/shoe-cleaning-packages', {
      method: 'GET',
      headers: {
    ...
    return (
      <View style={styles.mainContainer}>
        ...
        <View
          ...
          <Text style={styles.heading}>Sneaker Clean</Text>
        ...
        <ScrollView style={styles.servicesScroller}>
          <Image style={styles.image} source={require('../assets/clean.png')} />
          ...
          <TouchableOpacity onPress={() => {
            ...
            this.state.orderDetails.meta.push({ key: 'Package', value: this.state.selectDesign })
            this.state.orderDetails.meta.push({ key: 'Colour', value: this.state.selectColour })
            this.state.orderDetails.meta.push({ key: 'Time', value: this.state.selectType })
                  ...
                  return (
                    <View
                      ...
                      <View>
                        <TouchableOpacity
                          onPress={() => {
                            this.state.orderDetails.meta.push({ key: 'Design', value: item.title })
                          ...
                          <View
                            ...
                            <Image style={{ resizeMode: 'cover', width: '100%', height: 200, borderRadius: 0 }} source={{ uri: 'https://lab.mediabloo.com' + item.image.url }} />
                            <View style={{ flexDirection: 'row', justifyContent: 'space-between', backgroundColor: '#33feba', padding: 15, borderRadius: 10 }}>
                              <Text
                                style={{
                                  fontSize: 15,
                                  textAlign: 'center',
      ...
      <Modal
        ...
        <View style={styles.centeredView}>
          <View style={styles.colorsModalView}>
            ...
            <Text style={styles.modalTextBlack}>Select Color</Text>
      ...
      <Modal
        ...
        <View style={styles.centeredView}>
          <View style={styles.colorsModalView}>
            ...
            <Text style={styles.modalTextBlack}>Select Time</Text>
            <ScrollView style={{ width: '70%' }}>
              <FlatList
                  ...
                  return (
                    <View
                      ...
                      <View>
                        <TouchableOpacity
                          onPress={() => {
                            this.setState({ selectType: item.time })
                  ...
                  return (
                    <View
                      ...
                      <View>
                        <TouchableOpacity
                          onPress={() => {
                            this.setState({ selectSize: item.label })
